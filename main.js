...
function createElement(tagName, options) {
  var node = Object.assign(document.createElement(tagName), options);
...
var Widget = /*#__PURE__*/function () {
  ...
  return _createClass(Widget, [{
    ...
    value: function init() {
      ...
      document.addEventListener("keydown", /*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
          var textArea, start, end, text, htmlText;
              ...
              case 0:
                if (event.key === "Enter") {
                  if (event.ctrlKey) {
                    ...
                    event.preventDefault();
                    text = _this.inputMesage.value;
                    if (text.trim()) {
                      htmlText = "<div class=\"data\">".concat(text, "</div>");
                      _this.getPosition(htmlText);
                    }
                  }
                }
              case 1:
      ...
      document.addEventListener("click", /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
          var target, position, text, validPosition, confirmVideoRecord, stream, recorder, chunks, confirmAudioRecord, _stream, _recorder, _chunks;
            ...
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (target.classList.contains("ok")) {
                  position = _this.inputPosition.value.trim();
                  text = _this.inputMesage.value;
                  validPosition = positionValidation(position);
                  if (validPosition) {
                    _this.addTextMessage(text, validPosition);
                    _this.resetInput(_this.inputPosition);
                    _this.resetInput(_this.inputMesage);
                    _this.closeModal();
                  }
                  _this.showError();
                }
              ...
              case 8:
                ...
                recorder.addEventListener("stop", function () {
                  ...
                  var videoPlayer = "<video class=\"audio-player\" controls src=\"".concat(videoSrc, "\"></video>");
                  _this.getPosition(videoPlayer);
                });
                recorder.start();
              ...
              case 20:
                ...
                _recorder.addEventListener("stop", function () {
                  ...
                  var player = "<audio class=\"audio-player\" controls src=\"".concat(src, "\"></audio>");
                  _this.getPosition(player);
                });
                _recorder.start();
    ...
    key: "addTextMessage",
    value: function addTextMessage(text, position) {
      var listMessages = document.querySelector(".list-message");
      var textMessage = createElement("div", {
        className: "message-container",
        innerHTML: "\n        <div class=\"text-and_date\">\n            ".concat(text, "\n            <div class=\"date\">").concat(moment_default()().format("HH:mm DD.MM.YYYY"), "</div>\n        </div>\n        <div class=\"geolocation\">[").concat(position, "]</div>\n        ")
      });
    ...
    key: "getPosition",
    value: function getPosition(text) {
      var _this2 = this;
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function (data) {
          ...
          var position = "".concat(latitude, ",-").concat(longitude);
          _this2.addTextMessage(text, position);
          _this2.resetInput(_this2.inputMesage);
        }, function (error) {
          _this2.showModal();
          console.error(error);
        }, {
